package com.jaleny.bookcatalogue.ui.theme.Screens.registration
...
fun Registerscreen(navController: NavHostController){
    ...
    Column(modifier = Modifier
        ...
        OutlinedTextField(value =confirmpass , onValueChange = {
            confirmpass=it},
            label = { Text(text = "Enter Confirm Pass",style = Typography.titleLarge) },
        ...
        Button(onClick = {
            ...
            Text(text = "Register ",style = Typography.titleLarge)
        }
        Spacer(modifier = Modifier.height(20.dp))
        ...
        Button(onClick = {
            ...
            Text(text = "Have an Account? Click to Login",style = Typography.titleLarge)
        }
